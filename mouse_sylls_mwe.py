...
seg_dirs = 		[root+'temp_seg_C57', 	root+'temp_seg_DBA']
proj_dirs = 	[root+'temp_proj_C57', 	root+'temp_proj_DBA']
new_seg_dirs =	[root+'clean_seg_C57', 	root+'clean_seg_DBA']
spec_dirs = 	[root+'temp_C57_spec', 	root+'temp_DBA_spec']
...
# 3) Tune preprocessing parameters. #
#####################################
preprocess_params = tune_syll_preprocessing_params(audio_dirs, new_seg_dirs, \
		params['preprocess'])
